...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Recuerdame.Android.dll" comes first in this list. */
		"Recuerdame.Android.dll",
		"Acr.UserDialogs.dll",
		"AndHUD.dll",
		"FormsViewGroup.dll",
		"Microsoft.Azure.CognitiveServices.Language.LUIS.Runtime.dll",
